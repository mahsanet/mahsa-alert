...
const LocationPrivacyModal: React.FC<LocationPrivacyModalProps> = ({
	isOpen,
	onAccept,
	onDecline,
	isDarkMode,
	...
	return (
      ...
      `}
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
								برای بررسی امنیت موقعیت شما نسبت به نقاط خطرناک، نیاز به دسترسی
								به موقعیت جغرافیایی داریم.
							</p>
						</div>
					</div>
          ...
          `}
					>
						<strong>نکته:</strong> می‌توانید در هر زمان ردیابی موقعیت را متوقف
						کنید و این دسترسی کاملاً اختیاری است.
					</div>
				</div>
