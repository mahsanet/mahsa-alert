...
const Warning: React.FC<WarningProps> = ({ isVisible, onClose, isCompact = false, onExpand }) => {
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-2 mb-3 pr-6">
          ...
          {isCompact && (
            <svg className="w-4 h-4 text-gray-400 mr-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
